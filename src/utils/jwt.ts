 ...
 */
async function generateSignature(headerBy64: string, payloadBy64: string, secret: string): Promise<string> {
 ...
 * @param {string} secret 
 */
export async function signJwt(header: any, payload: any, secret: string): Promise<string | null> {
    try {
