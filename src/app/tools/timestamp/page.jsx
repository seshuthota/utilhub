        ...
        <div className={styles.container}>
            <header className={styles.header}>
                ...
                <div className={styles.currentClock}>
                    ...
                    <button onClick={() => setIsPaused(!isPaused)} className={styles.iconBtn}>
                ...
                <div className={styles.card}>
                    ...
                    {displayDate ? (
                        <div className={styles.formatList}>
                            ...
                            <FormatRow label="Relative" value={format(displayDate, "yyyy-MM-dd 'at' HH:mm")} />
                            <FormatRow label="Day of Year" value={format(displayDate, 'ddd')} />
                            <FormatRow label="Week of Year" value={format(displayDate, 'wo')} />
                        </div>
                    ) : (
