...
const EXAMPLE_CMD = 'docker run -d -p 80:80 -v /var/run/docker.sock:/tmp/docker.sock:ro --name nginx nginx';
                ...
                <div className={styles.splitView}>
                    ...
                    <div className={styles.pane}>
                        <div className={styles.paneHeader}>
                            ...
                            <ActionToolbar content={output} currentToolId="docker-converter" />
                        </div>
                        <div className={styles.editorArea}>
                            <CodeEditor
                                value={output}
