...
export default function JwtTool() {
    ...
    const [mode, setMode] = useState('decode'); // 'decode' or 'sign'
    ...
    // Signing logic effect to auto-update (optional, maybe better to have explicit button?)
    // Let's do explicit for now or debounced.
