        ...
        <div className={styles.container}>
            <header className={styles.header}>
                ...
                <div className={styles.actions}>
                    <button className={styles.button} onClick={downloadJson} title="Export JSON" disabled={data.length === 0}>
            ...
            <div className={styles.split}>
                <div className={styles.pane}>
                    ...
                    <div className={styles.editor}>
                        <Editor
                            value={input}
                            onValueChange={(val) => { setInput(val); parseCsv(val); }}
                            highlight={code => Prism.highlight(code, Prism.languages.csv || Prism.languages.text, 'csv')}
                            padding={20}
                            style={{
