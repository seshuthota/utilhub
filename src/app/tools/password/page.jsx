...
export default function PasswordTool() {
    ...
    const getScoreColor = (score) => {
        switch (score) {
            case 0: return '#ff4444'; // Very Weak
            case 1: return '#ffbb33'; // Weak
            case 2: return '#ffbb33'; // Fair
            case 3: return '#00C851'; // Good
            case 4: return '#007E33'; // Strong
            default: return '#ccc';
        }
    };
                    ...
                    <div className={styles.analysis}>
                        <div className={styles.scoreSection}>
                            <div className={styles.scoreHeader}>
                                ...
                                <span style={{ color: getScoreColor(result.score) }} className={styles.scoreLabel}>
                        ...
                        <div className={styles.statsGrid}>
                            ...
                            <div className={styles.statCard}>
                                ...
                                <div>{result.crack_times_display.online_no_throttling_10_per_second}</div>
                            </div>
                            <div className={styles.statCard}>
                                <label>Crack Time (Offline)</label>
                                <div>{result.crack_times_display.offline_slow_hashing_1e4_per_second}</div>
                            </div>
                        </div>
