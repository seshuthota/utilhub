...
export default function ConfigConverter() {
    ...
    const stringifyContent = (obj, format) => {
        switch (format) {
            ...
            case 'yaml': return yaml.dump(obj);
    ...
    return (
        <div className={styles.container}>
            <header className={styles.header}>
                ...
                <button className="btn-secondary" onClick={() => setInput(EXAMPLE_JSON)}>
                    Load Example
                </button>
            </header>
                ...
                <div className={styles.splitView}>
                    <div className={styles.pane}>
                        <div className={styles.paneHeader}>
                            ...
                            <button className="btn-icon" onClick={handleSwap} title="Swap Formats">
                        ...
                        {error && (
                            <div className={styles.error}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                                    <AlertCircle size={16} /> <strong>Error parsing {sourceFmt.toUpperCase()}</strong>
                                </div>
                                {error}
                            </div>
                        )}
                    ...
                    <div className={styles.pane}>
                        <div className={styles.paneHeader}>
                            ...
                            <ActionToolbar content={output} currentToolId="config-converter" />
                        </div>
                        <div className={styles.editorArea}>
                            <CodeEditor
                                value={output}
