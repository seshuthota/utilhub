...
const initDb = () => {
    alasql(
        "CREATE TABLE IF NOT EXISTS users (id INT, name STRING, email STRING, role STRING)",
    );
    ...
    alasql(
        'INSERT INTO users VALUES (3, "Charlie", "charlie@example.com", "user")',
    );

    alasql(
        "CREATE TABLE IF NOT EXISTS products (id INT, name STRING, price MONEY, stock INT)",
    );
    ...
    alasql(
        "CREATE TABLE IF NOT EXISTS orders (id INT, user_id INT, product_id INT, date DATE)",
    );
    ...
    return (
        <div className={styles.container}>
            ...
            <div
                ...
                style={{ flexDirection: "column", height: "auto", gap: "1rem" }}
            >
                {/* Editor & Actions */}
